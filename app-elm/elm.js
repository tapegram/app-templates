...
var $author$project$Main$CreateUser = {$: 'CreateUser'};
var $author$project$Main$NotFound = {$: 'NotFound'};
var $author$project$Main$Users = {$: 'Users'};
		...
		switch (_v0) {
			case '/users/create':
				return A2(
					...
					'/users/create',
					_Utils_Tuple2(
						{page: $author$project$Main$CreateUser},
			...
			case '/users':
				return A2(
					...
					'/users',
					_Utils_Tuple2(
						{page: $author$project$Main$Users},
						$elm$core$Platform$Cmd$none));
			case '/':
				return A2(
					$elm$core$Debug$log,
...
var $author$project$Main$viewHeader = function (page) {
						...
						_List_fromArray(
							[
								...
								$author$project$Main$isActive(
									{
										link: route,
										page: A2($elm$core$Debug$log, 'Rendering nav link with', page)
									}))
							]))
					]),
				_List_fromArray(
	...
	var logo = A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('Template Users App')
			]));
	var links = A2(
		$elm$html$Html$ul,
		_List_Nil,
		_List_fromArray(
			[
				A2(
				navLink,
				$author$project$Main$Users,
				{caption: 'Users', url: '/users'}),
				A2(
				navLink,
				$author$project$Main$CreateUser,
				{caption: 'Create User', url: '/users/create'})
			]));
	return A2(
		$elm$html$Html$nav,
		_List_fromArray(
